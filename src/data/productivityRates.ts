...
// Previous rates for spotting and spraying
export const carpetMaintenanceRates: ProductivityRate[] = [
  {
    ...
    unit: "Spot",
    ratePerHour: 7.74 // 60 minutes / 7.75 minutes per spot
  },
  {
    id: "SSP-2M",
    category: "Carpet Maintenance - Spraying and Spotting",
    ...
    unit: "Spot",
    ratePerHour: 12 // 60 minutes / 5 minutes per spot
  },
  {
    id: "SSP-3M",
    category: "Carpet Maintenance - Spraying and Spotting",
    ...
    tool: "Spotting chemical, blotting cloth, and bone tool",
    unit: "Spot",
    ratePerHour: 10 // 60 minutes / 6 minutes per spot
  },
  {
    id: "SSP-4M",
    category: "Carpet Maintenance - Spraying and Spotting",
    ...
    tool: "Spotting chemical, blotting cloth, and bone tool",
    unit: "Spot",
    ratePerHour: 15 // 60 minutes / 4 minutes per spot
  },
  {
    id: "SSP-5M",
    category: "Carpet Maintenance - Spraying and Spotting",
    ...
    tool: "Spotting chemical, blotting cloth, and bone tool",
    unit: "Spot",
    ratePerHour: 5 // 60 minutes / 12 minutes per spot
  }
];

export const carpetVacuumRates: ProductivityRate[] = [
  {
    id: "TST-1M",
  ...
  },
  {
    id: "BPV-1M",
    category: "Carpet Maintenance - Vacuum",
    task: "Vacuum with Corded Backpack Vacuum and Tool",
    tool: "14\" / 356 mm blade",
    unit: "m²",
    ratePerHour: 761
  },
  {
  ...
  },
  {
    id: "BPV-6M",
    category: "Carpet Maintenance - Vacuum",
    task: "Vacuum with Cordless Backpack Vacuum and Tool",
    tool: "14\" / 356 mm blade",
    unit: "m²",
    ratePerHour: 1466
  },
  ...
  },
  {
    id: "UVC-1M",
    category: "Carpet Maintenance - Vacuum",
    task: "Vacuum with Upright Vacuum (Cordless)",
    tool: "8\" / 203 mm battery",
    unit: "m²",
    ratePerHour: 185
  },
  {
    id: "UVC-2M",
    category: "Carpet Maintenance - Vacuum",
    task: "Vacuum with Upright Vacuum (Corded)",
    tool: "12\" / 305 mm",
    unit: "m²",
    ratePerHour: 209
  },
  ...
  },
  {
    id: "LAM-1M",
    category: "Carpet Maintenance - Vacuum",
    task: "Vacuum Wide-Area Machines",
    tool: "28\" / 711 mm",
    unit: "m²",
    ratePerHour: 892
  },
...
export const getAllProductivityRates = (): ProductivityRate[] => {
  return [...carpetMaintenanceRates, ...carpetVacuumRates];
};
